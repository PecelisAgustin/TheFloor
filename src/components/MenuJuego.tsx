...
export function MenuJuego() {
    ...
    const notEnoughCategoriesForVueltas =
        isPapaCaliente && selectedCategories.length < vueltas * totalPlayers;
    const invalidVueltas = isPapaCaliente && vueltas < 1;
    ...
    return (
        <main className="menu">
            ...
            <div className="menu-card">
                <h1 className="title">
                    {isPapaCaliente ? "PAPA CALIENTE" : "THE FLOOR"}
                </h1>
                ...
                <button
                    onClick={() => navigate(`/players?mode=${mode}`)}
                    className="start-btn"
                    disabled={!canStart}
                >
                    Comenzar partida
